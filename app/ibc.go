...
import (
	tttibcmodule "tic-chain/x/tttibc/module"
...
func (app *App) registerIBCModules() {
	...
	tttibcIBCModule := ibcfee.NewIBCMiddleware(tttibcmodule.NewIBCModule(app.TttibcKeeper), app.IBCFeeKeeper)
	ibcRouter.AddRoute(tttibcmoduletypes.ModuleName, tttibcIBCModule)
