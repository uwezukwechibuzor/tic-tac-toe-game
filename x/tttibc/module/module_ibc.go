...
func (im IBCModule) OnRecvPacket(
	...
	var modulePacketData types.TttibcPacketData
	...
	case *types.TttibcPacketData_IbcgamePacket:
		packetAck, err := im.keeper.OnRecvIbcgamePacket(ctx, modulePacket, *packet.IbcgamePacket)
		if err != nil {
...
func (im IBCModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.TttibcPacketData_IbcgamePacket:
		err := im.keeper.OnAcknowledgementIbcgamePacket(ctx, modulePacket, *packet.IbcgamePacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeIbcgamePacket
...
func (im IBCModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.TttibcPacketData_IbcgamePacket:
		err := im.keeper.OnTimeoutIbcgamePacket(ctx, modulePacket, *packet.IbcgamePacket)
		if err != nil {
			return err
		}
